/* NACOR Exam Simulator, Application Logic */

const ACCESS_CODE  = "NACOR9000";
const EXAM_SECONDS = 9000;  // 150 minutes (config.json exam.timer_hours = 2.5)
const PASSING_PCT  = 61;
const STORAGE_KEY  = "nacor_exam_state_v1";
const SIM_Q_COUNT  = 150;  // simulator serves this project's configured pool size (config.json exam.sim_questions)
const DOMAIN_LABELS = {"basic_dispensing_and_lens_finishing_theory": "Basic Dispensing and Lens Finishing Theory", "lens_neutralization": "Lens Neutralization", "measurement": "Measurement", "verification": "Verification", "service": "Service"};  // maps domain key -> human-readable label for display
